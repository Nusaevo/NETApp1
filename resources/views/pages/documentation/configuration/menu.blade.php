<x-base-layout>
    ...
    <div class="pb-10">
        ...
        <div class="py-5">
            ...
            <p class="mb-3">
                The demo config can be found in the config folder <code>config/global/menu.php</code>. The menu in this config will be specifically available for current selected demo.
            </p>
        </div>
        <!--end::Block-->
...
", 'php')
            ...
            <p class="mb-0">
                Each menu item added to the <code>config/global/menu.php</code>, must a page config registered with it. The pages config can be found in <code>config/global/pages.php</code>.
