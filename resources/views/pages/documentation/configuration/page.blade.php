<x-base-layout>
    ...
    <div class="pb-10">
        ...
        <div class="py-5">
            ...
            <p class="mb-3">
                The demo config can be found in the config folder <code>config/global/page.php</code>. The page in this config will be specifically available for current selected demo.
            </p>
        </div>
        <!--end::Block-->
...
", 'php')
        ...
        <div class="py-5">
            <p class="mb-3">
                Each page may contains this config to override the global value. For example JS and CSS assets from general config in <code>config/global/general.php</code>
            </p>
