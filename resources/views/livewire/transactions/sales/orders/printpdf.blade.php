...
<div>
    <a href="{{ route('sales.order.index') }}" class="btn btn-link btn-color-info btn-active-color-primary me-5 mb-2"><i class="bi bi-arrow-left-circle fs-2 me-2"></i> Sales Order </a>
</div>
        ...
        <div class="invoice-box" >
          <table>
              ...
              <tr>
                  ...
                  <td class="item"> {{ rupiah($so->price ) }} </td>
                  <td class="item"> {{ rupiah($so->price * $so->qty_wo  ) }} </td>
              ...
              @endforeach
              <tr class="total">
                <td class="info"colspan="4"><b>TOTAL :</b></td>
                <td class="text-end" colspan="2"><b>{{ rupiah($grand_total) }}</b></td>
              </tr>
          </table>
      </div></div>
    </div>
