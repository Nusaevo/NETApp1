                                        ...
                                        <table id="tbl" class="table table-striped table-hover gy-7 gs-7">
                                            <thead>
                                                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                                    ...
                                                    <th class="min-w-200px">Barang</th>
                                            ...
                                            <tbody >
                                                <div>
                                                    @foreach($inputs as $key => $input)
                                                        ...
                                                        <td class="border">
                                                                <input type="number" wire:model.defer='input_items.{{ $key }}.price' class="form-control @error("input_items.$key.price") is-invalid @enderror"  wire:change="$emit('sales_order_create_change_price',{{ $key }} , $event.target.value)" placeholder="7500" required>
                                                                @error("input_items.$key.price") <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                                                        </td>
                                                        <td class="border">
                                                                <input type="number" wire:model.defer='input_items.{{ $key }}.qty' class="form-control @error("input_items.$key.qty") is-invalid @enderror"  wire:change="$emit('sales_order_create_change_qty',{{ $key }} , $event.target.value)" placeholder="10" required>
