                    ...
                    <x-ui-card>
                        <div class="row">
                            ...
                            <x-ui-dropdown-select label="{{ $this->trans('partner_type') }}" clickEvent=""
                                model="inputs.grp" :options="$partnerTypes" required="true" :action="$actionValue" onChanged="onPartnerChanged"/>
                        </div>
                        ...
                        @if ($inputs['grp'] == Partner::CUSTOMER)
                            <div class="row">
                                <x-ui-text-field label="{{ $this->trans('ring_size') }}" model="inputs.ring_size"
                                    type="text" :action="$actionValue" />
                                <x-ui-text-field label="{{ $this->trans('partner_ring_size') }}"
                                    model="inputs.partner_ring_size" type="text" :action="$actionValue" />
                            </div>
                        @endif
                    </x-ui-card>
                </div>
