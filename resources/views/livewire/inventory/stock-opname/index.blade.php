                ...
                <div id="kt_docs_card_collapsible" class="collapse" wire:ignore.self>
                    <div class="card-body">
                        <div class="mb-10">
                            ...
                            <select class="form-select @error('inputs.warehouse_id') is-invalid @enderror" wire:model.lazy="inputs.warehouse_id">
                        ...
                        <div class="mb-10">
                            ...
                            <input wire:model.debounce.1s="inputs.name" type="text" class="form-control @error('inputs.name') is-invalid @enderror"/>
                            @error('inputs.name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    <div class="card-footer">
                        <button  wire:loading.remove type="{{ $button_type ?? 'button' }}" wire:click="$emit('master_item_warehouse_search')" class="btn btn-primary me-10"> {{ $button_text ?? 'Search' }} </button>
                        ...
                        <table id="tbl" class="table table-striped table-hover gy-7 gs-7">
                            <thead>
                                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                    ...
                                    <th class="min-w-10px">Qty</th>
                                    <th class="min-w-10px">Qty Defect</th>
