            ...
            <x-ui-tab-view-content id="myTabContent" class="tab-content">
                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                    <x-ui-card>
                        ...
                        <x-ui-text-field label="Step Count" model="inputs.step_cnt" type="number" :action="$actionValue" placeHolder="" visible="true" span="Full" />
                        <x-ui-text-field label="Descr" model="inputs.descr" type="text" :action="$actionValue" required="false" placeHolder="" visible="true" span="Full"/>
                    </x-ui-card>
                </div>
