<div>
    ...
    <x-ui-page-card isForm="true"
        title="{{ $this->trans($actionValue) }} Sales Return {{ $this->object->tr_id ? ' (Return #' . $this->object->tr_id . ')' : '' }}"
        status="{{ $this->trans($status) }}">

        <x-ui-tab-view id="myTab" tabs="General,Exchange Items"> </x-ui-tab-view>
        ...
        <x-ui-tab-view-content id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade show active" id="General" role="tabpanel" aria-labelledby="general-tab">
                <div class="row mt-4">
                    ...
                    <x-ui-card title="Return Items (Barang yang dikembalikan)">
                        <div>
                            <div class="row">
                                <x-ui-dropdown-select label="Lokasi" model="wh_code" :options="$warehouseOptions" />
                                <x-ui-text-field label="Klik di sini dan scan barcode" model="barcode" type="barcode"
            ...
            <!-- Exchange Items Tab -->
            <div class="tab-pane fade" id="Exchange Items" role="tabpanel" aria-labelledby="exchange-items-tab">
                <div class="row mt-4">
                    <x-ui-card title="Exchange Items (Barang Pengganti/Tukar Barang)">
                        <div class="row">
                            <x-ui-dropdown-select label="Exchange Lokasi" model="exchange_wh_code" :options="$warehouseOptions" />
                        </div>
                        ...
                        <x-ui-dialog-box id="exchangeItemDialogBox" title="Search Exchange Item" width="600px" height="1000px"
                            ...
                            <x-slot name="body">
                                <div class="row">
                                    <x-ui-text-field type="text" label="Search Code/Nama" model="exchange_searchTerm"
                                        required="true" :action="$actionValue" enabled="true" clickEvent=""
                                        buttonName="" />
                                </div>
