<div>
            ...
            <form wire:submit.prevent='{{ $is_edit_mode ? 'update' : 'store' }}' class="form w-100">
                ...
                <div id="kt_docs_card_collapsible" class="collapse show">
                    <div class="card-body">
                        ...
                        <div class="mb-10">
                            <label class="form-label">Kode Barcode (Mohon biarkan 0 jika tidak ada barcode di barangw)</label>
                            <input wire:model.debounce.1s="inputs.barcode" type="number" class="form-control @error('inputs.barcode') is-invalid @enderror"
                                />
                            @error('inputs.barcode')
                        ...
                        <table id="tbl" class="table table-striped table-hover gy-7 gs-7">
                            <thead>
                                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                    ...
                                    <th class="min-w-10px">Kode Barcode</th>
                                ...
                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" wire:click="$emit('master_item_unit_detail_delete',  {{ $item_unit->id}})" class="btn btn-primary btn-sm"><i class="bi bi-trash-fill fs-2 me-2"></i></a>
                                            <a wire:click="$emit('master_item_unit_detail_pdf',  {{ $item_unit->id}})"   class="btn btn-primary btn-sm"><i class="fa fa-print fs-2 me-2"></i>Print Barcode</a></td>
                                            {{-- <a href="{{ route('item.detail.print_barcode', ['id'=>$item_unit->id ]) }}"   class="btn btn-primary btn-sm"><i class="fa fa-print fs-2 me-2"></i>Print Barcode</a></td> --}}
                                        </tr>
                                    @endforeach
                                </div>
                            </tbody>
    ...
    @include('layout.customs.modal-delete', ['destroy_listener' => 'master_item_unit_detail_delete'])
</div>
