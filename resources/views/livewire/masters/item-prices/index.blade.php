            ...
            <form class="form w-100">
                ...
                <div id="kt_docs_card_collapsible" class="collapse" wire:ignore.self>
                    ...
                    <div class="card-footer">
                        <button  wire:loading.remove type="{{ $button_type ?? 'button' }}" wire:click="$emit('master_item_price_search')" class="btn btn-primary me-10"> {{ $button_text ?? 'Search' }} </button>
                        ...
                        <table id="tbl" class="table table-striped table-hover gy-7 gs-7">
                            <thead>
                                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                    ...
                                    <th class="min-w-10px">Harga baru</th>
