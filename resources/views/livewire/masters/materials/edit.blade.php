            ...
            <x-ui-tab-view-content id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade" id="detail" role="tabpanel" aria-labelledby="detail-tab">
                    <x-ui-expandable-card id="detail" title="Material Detail" :isOpen="true">
                        <x-ui-text-field label="Sequence" model="input_details.seq" type="number" :action="$action" required="true" placeholder="Enter Sequence" />
                        <x-ui-text-field label="Sides Carat" model="input_details.jwl_sides_carat" type="number" :action="$action" required="false" placeholder="Enter Sides Carat" span="Half" />
                        <x-ui-text-field label="Sides Count" model="input_details.jwl_sides_cnt" type="number" :action="$action" required="false" placeholder="Enter Sides Count" span="Half" />
                        <x-ui-text-field label="Sides Material" model="input_details.jwl_sides_matl" type="text" :action="$action" required="false" placeholder="Enter Sides Material" span="Half" />
                        <x-ui-text-field label="Sides Parcel" model="input_details.jwl_sides_parcel" type="text" :action="$action" required="false" placeholder="Enter Sides Parcel" span="Half" />
                        <x-ui-text-field label="Sides Price" model="input_details.jwl_sides_price" type="number" :action="$action" required="false" placeholder="Enter Sides Price" span="Half" />
                        <x-ui-text-field label="Sides Amount" model="input_details.jwl_sides_amt" type="number" :action="$action" required="false" placeholder="Enter Sides Amount" span="Half" />
