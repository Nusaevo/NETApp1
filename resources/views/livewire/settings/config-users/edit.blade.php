                ...
                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                    <x-ui-expandable-card id="UserCard" title="User" :isOpen="true">
                        @if ($actionValue == 'Create')
                            <x-ui-text-field label="Login ID" model="inputs.code" type="text" span="Full" :action="$actionValue" required="true" placeHolder="Enter Login ID (e.g., johndoe123)" visible="true"/>
                        @else
                            <x-ui-text-field label="Login ID" model="inputs.code" type="text" span="Full" :action="$actionValue" required="true" enabled="false" placeHolder="Enter Login ID" visible="true"/>
                        @endif
