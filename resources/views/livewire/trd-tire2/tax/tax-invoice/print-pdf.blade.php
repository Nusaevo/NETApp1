...
<div>
                        ...
                        @foreach ($orders as $order)
                            ...
                            @foreach ($order->OrderDtl as $index => $detail)
                                @php
                                    ...
                                    $lineAmt =
                                        isset($detail->amt_beforetax) && $detail->amt_beforetax > 0
                                            ? (float) $detail->amt_beforetax
                                ...
                                <tr style="line-height: 1.2;">
                                    @if ($index === 0)
                                        <td rowspan="{{ count($order->OrderDtl) }}"
                                            style="text-align: left; padding: 5px; vertical-align: top;">
                                            {{ $order->tr_code }}</td>
                                        <td rowspan="{{ count($order->OrderDtl) }}"
                                            style="text-align: left; padding: 5px; vertical-align: top;">
                                            {{ $order->tax_doc_num }}</td>
                                        <td rowspan="{{ count($order->OrderDtl) }}"
                                            style="text-align: left; padding: 5px; vertical-align: top;">
                                            {{ \Carbon\Carbon::parse($order->tr_date)->format('d-M-Y') }}</td>
                                        <td rowspan="{{ count($order->OrderDtl) }}"
                                            style="text-align: left; padding: 5px; vertical-align: top;">
                                    ...
                                    <td style="text-align: right; padding: 5px;">
                                        {{ number_format($detail->amt_beforetax + $detail->amt_tax, 0, ',', '.') }}
                            ...
                            @endforeach
                            <tr>
                                <td colspan="5" style="text-align: right; padding: 5px;"></td>
                                <td
                                    style="text-align: right; padding: 5px; font-weight: bold; border-bottom: 1px solid #000;">
                                    {{ number_format($totalQty, 0, ',', '.') }}
                                </td>
                                <td style="text-align: center; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;"></td>
                                <td
                                    style="text-align: right; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;">
                                    {{ number_format($sumAmt, 0, ',', '.') }}</td>
                                <td
                                    style="text-align: right; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;">
                                    {{ number_format($sumPpn, 0, ',', '.') }}</td>
                                <td
                                    style="text-align: right; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;">
    ...
    <div id="print" class="d-none d-print-block">
        <div style="max-width: 1200px; margin: 0 auto; font-family: 'Calibri'; font-size: 14px; padding: 10px;">
            <div class="invoice-box" style="max-width: 1200px; margin: auto; padding: 10px;">
                @if ($orders->isEmpty())
                            ...
                            <tbody>
                                @foreach ($chunk as $item)
                                    @php
                                        ...
                                        $printTotalAmt += $lineAmt;
                                        $printTotalPpn += $ppn;
                                        $printTotalAmtNota += $detail->amt;
                                    ...
                                    <tr style="line-height: 1.2;">
                                        ...
                                        <td style="text-align: right; padding: 5px;">
                                            {{ number_format($detail->amt_beforetax, 0, ',', '.') }}
                                        </td>
                                        <td style="text-align: right; padding: 5px;">
                                            {{ number_format($detail->amt_tax, 0, ',', '.') }}
                                        </td>
                                        <td style="text-align: right; padding: 5px;">
                                            {{ number_format($detail->amt_beforetax + $detail->amt_tax, 0, ',', '.') }}
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="text-align: right; padding: 5px; font-weight: bold; border-bottom: 1px solid #000;">
                                        {{ number_format($printTotalQty, 0, ',', '.') }}
                                    </td>
                                    <td style="text-align: center; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;"></td>
                                    <td
                                        style="text-align: right; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;">
                                        {{ number_format($printTotalAmt, 0, ',', '.') }}
                                    </td>
                                    <td
                                        style="text-align: right; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;">
                                    ...
                                    <td
                                        style="text-align: right; padding: 5px; border-bottom: 1px solid #000; font-weight: bold;">
                                        {{ number_format($printTotalAmt + $printTotalPpn, 0, ',', '.') }}
                                    </td>
                                    <td style="text-align: right; padding: 5px; font-weight: bold;">
                                        {{ number_format($printTotalAmtNota, 0, ',', '.') }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
