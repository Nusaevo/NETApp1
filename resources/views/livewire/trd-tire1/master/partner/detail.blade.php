        ...
        <x-ui-page-card title="{{ $this->trans($actionValue) }} {!! $menuName !!}"
            ...
            @endif
                <x-ui-tab-view-content id="myTabContent" class="tab-content">
                                    ...
                                    <x-ui-padding>
                                        <div class="row">
                                            <x-ui-dropdown-select label="{{ $this->trans('category') }}"
                                                model="inputs.grp" :options="$PartnerType" required="true"
                                                :action="$actionValue" />
                                            <x-ui-text-field label="{{ $this->trans('partner_code') }}"
                                                model="inputs.code" type="text" :action="$actionValue" enabled="false" />
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <x-ui-text-field label="{{ $this->trans('address') }}"
                                                model="inputs.address" type="textarea" required="true"
                                                :action="$actionValue" />
                                        </div>
                                        <div class="row">
                                            <x-ui-text-field label="{{ $this->trans('country') }}"
                                                model="inputs.country" type="text" :action="$actionValue"
                                                required="true" />
                                            <x-ui-text-field label="{{ $this->trans('province') }}"
                                                model="inputs.province" type="text" :action="$actionValue"
                                                required="true" />
                    ...
                    <div class="tab-pane fade show" id="npwp" role="tabpanel"
                        aria-labelledby="npwp-tab">
