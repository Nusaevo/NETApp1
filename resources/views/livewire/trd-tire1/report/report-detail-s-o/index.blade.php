                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-md-10">
                            <div class="row align-items-end">
                                <!-- Row 1: Date fields -->
                                <div class="col-md-4">
                                    <x-ui-text-field label="Tanggal Awal:" model="startCode" type="date"
                                        action="Edit" />
                                </div>
                                <div class="col-md-4">
                                    <x-ui-text-field label="Tanggal Akhir:" model="endCode" type="date"
                                        action="Edit" />
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row align-items-end mt-3">
                                ...
                                <div class="col-md-4">
                                    <x-ui-dropdown-search label="Customer" model="filterPartner" optionValue="id"
                                        :query="$ddPartner['query']" :optionLabel="$ddPartner['optionLabel']" :placeHolder="$ddPartner['placeHolder']" :selectedValue="$filterPartner"
                                        required="false" action="Edit" enabled="true" type="int"
                                        onChanged="onPartnerChanged" />
                                </div>
                                <div class="col-md-4">
                                    <x-ui-dropdown-search label="Kode Barang" model="filterMaterialId" optionValue="id"
                                        :query="$materialQuery" optionLabel="code,name"
                                        placeHolder="Ketik untuk cari barang..." :selectedValue="$filterMaterialId" required="false"
                                        action="Edit" enabled="true" type="int" onChanged="onMaterialChanged" />
                                </div>
                                <div class="col-md-4">
                                    <x-ui-dropdown-select label="Status" model="filterStatus" :options="$this->getStatusOptions()"
                                        action="Edit" />
                                </div>
                            </div>
                            ...
                            <div class="row align-items-end mt-3">
                                ...
                                <div class="col-md-4">
                                    <x-ui-dropdown-select label="Tipe Penjualan" model="filterSalesType"
                                        :options="$this->getSalesTypeOptions()" action="Edit" />
                                </div>
                                <div class="col-md-8">
