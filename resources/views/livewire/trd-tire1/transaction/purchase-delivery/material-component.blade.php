        ...
        <x-ui-table id="Table">
                ...
                @foreach ($input_details as $key => $input_detail)
                    <tr wire:key="list{{ $input_detail['id'] ?? $key }}">
                        ...
                        <td style="text-align: center;">
                            <x-ui-text-field model="input_details.{{ $key }}.qty_order" enabled="true"
                                class="form-control" type="number" enabled="false" :action="$actionValue" />
                        </td>
                        <td style="text-align: center;">
                            <x-ui-text-field model="input_details.{{ $key }}.qty" label="" enabled="true"
                                :action="$actionValue" type="number" required="true" />
                        </td>
                        <td style="text-align: center;">
            ...
            <x-slot name="button">
                <x-ui-button clickEvent="addItem" cssClass="btn btn-primary" iconPath="add.svg" button-name="Add"
                    :enabled="$inputs['reffhdrtr_code'] ? true : false" />
            </x-slot>
        </x-ui-table>
    </x-ui-card>
