...
<div id="backManualButtonContainer">
    <a href="{{ isset($clickEvent) ? $clickEvent : '#' }}" class="btn btn-link btn-color-info btn-active-color-primary me-3 mb-2" id="backManualButton" wire:loading.attr="disabled">
        <i class="bi bi-arrow-left-circle fs-2 me-1"></i>
        <span id="backManualButtonText" style="font-size: 12px;" wire:loading.remove>Back</span>
        <span class="spinner-border spinner-border-sm" id="backManualButtonLoading" role="status" aria-hidden="true" wire:loading></span>
    </a>
</div>
@else
