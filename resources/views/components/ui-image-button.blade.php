    ...
    @if (isset($action) && $action !== 'View')
        <div class="image-button-container">
            <button id="btnAdd" class="btn btn-secondary" onclick="toggleAddPopup()"
                @if (!(isset($enabled) && $enabled === 'always') && (isset($enabled) && $enabled === 'false')) disabled @endif>
            ...
            <div id="addPopup" class="popup shadow-lg p-3 mb-5 bg-white rounded" style="display: none;">
                ...
                @if (isset($hideStorageButton) && $hideStorageButton == 'false')
                    <button class="btn btn-secondary w-100 text-left" data-bs-target="#storageDialogBox"
        ...
        <script>
            ...
            document.addEventListener('livewire:init', () => {
                document.addEventListener('click', function(event) {
                    const isClickInside = document.getElementById('btnAdd').contains(event.target) || document
                        .getElementById('addPopup').contains(event.target);
                    if (!isClickInside) {
            ...
            function handleFileUpload(event) {
                ...
                Array.from(files).forEach(file => {
                    ...
                    reader.onload = function(e) {
                        Livewire.dispatch('captureImages', {
