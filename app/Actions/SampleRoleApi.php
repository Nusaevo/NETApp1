...
class SampleRoleApi
{
    ...
    //     $query = Role::query()->with('permissions')->with('config_users');
    ...
    //     $query = ConfigUser::whereHas('roles', function ($query) use ($role_id) {
    ...
    // public function get($id, $relations = ['permissions', 'config_users'])
    // {
