...
class UiDropdownMultipleSelect extends UiBaseComponent
{
    ...
    // Event name triggered when the dropdown value changes
    public $onChanged;

    /**
     * Constructor for the UiDropdownMultipleSelect component.
     *
     ...
     * @param string $placeHolder   Placeholder text displayed when the field is empty.
     */
    ...
    /**
     * Render the view for the UiDropdownMultipleSelect component.
     *
    ...
    public function render()
    {
        ...
        return view('components.ui-dropdown-multiple-select');
    }
}
