...
namespace App\Http\Livewire\TrdJewel1\Transaction\Sales\FinishedOrders;
...
class IndexDataTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Aksi', 'id')
                ->format(
                    fn ($value, $row, Column $column) => view('livewire.transaction.sales.finishedorders.index-data-table-action')->withValue($row)
                )
        ];
    }
