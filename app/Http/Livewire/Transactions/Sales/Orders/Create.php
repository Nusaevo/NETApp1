...
class Create extends Component
{
    ...
    {
        return view('livewire.transactions.sales.orders.create');
    }
    ...
    public function changeItem($id, $value, $index)
    {
        if (isset($this->input_headers['category_id'])) {
            ...
            if ($duplicated == false) {
                ...
                $this->dispatchBrowserEvent('notify-swal', ['type' => 'error', 'title' => 'Berhasil', 'message' =>  "Produk dan satuan telah dibuat sebelumnya, mohon dicek kembali!"]);
            }
            ...
            try {
                ...
                foreach ($this->input_items as $item_id => $input_item) {
                    if (isset($input_item['item_unit_id'])) {
                        ...
                        $total_amount += $input_item['price'] * $input_item['qty'];
                    }
                }
