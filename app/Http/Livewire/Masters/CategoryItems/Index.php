...
class Index extends Component
{
    ...
    {
        return redirect()->route('item_category.detail', ['action' => 'View', 'objectId' => $id]);
    }

    public function Edit($id)
    {
        return redirect()->route('item_category.detail', ['action' => 'Edit', 'objectId' => $id]);
    }

    public function SelectObject($id)
    {
        $this->object = CategoryItem::findOrFail($id);
    }
