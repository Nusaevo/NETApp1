...
class Index extends Component
{
    ...
    {
        return redirect()->route('price_category.detail', ['action' => 'View', 'objectId' => $id]);
    }

    public function Edit($id)
    {
        return redirect()->route('price_category.detail', ['action' => 'Edit', 'objectId' => $id]);
    }

    public function SelectObject($id)
    {
        $this->object = PriceCategory::findOrFail($id);
    }
