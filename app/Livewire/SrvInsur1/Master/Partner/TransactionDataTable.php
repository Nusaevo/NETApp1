...
class TransactionDataTable extends Component
{
    ...
    public function getData()
    {
        ...
        return DB::connection(Constant::SrvInsur1_ConnectionString())->select($finalQuery, $bindings);
    }

    public function render()
    {
        return view('livewire.srv-insur1.master.partner.transaction-data-table', [
            'data' => $this->getData(),
        ]);
    }
}
