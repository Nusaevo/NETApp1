...
namespace App\Livewire\TrdTire2\Transaction\PurchaseDelivery;

use App\Livewire\Component\BaseComponent;
use App\Models\TrdTire2\Master\{Partner, Material};
use App\Models\TrdTire2\Transaction\{DelivHdr, DelivDtl, DelivPacking, OrderHdr, OrderDtl};
use App\Models\SysConfig1\ConfigConst;
use App\Enums\Status;
use App\Models\TrdTire2\Transaction\DelivPicking;
use App\Services\TrdTire2\Master\MasterService;
use App\Services\TrdTire2\OrderService;
use Exception;
use App\Models\TrdRetail1\Inventories\IvtBal;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;
use App\Services\TrdTire2\DeliveryService;
use App\Services\TrdTire2\BillingService;
...
class Detail extends BaseComponent
{
    ...
    public function onPurchaseOrderChanged($value)
    {
        ...
        if ($value) {
            ...
            //     $data = \App\Models\TrdTire2\Transaction\OrderDtl::join('order_hdrs', 'order_dtls.trhdr_id', '=', 'order_hdrs.id')
            //     ->where('order_hdrs.tr_type', 'PO')
