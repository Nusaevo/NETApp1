...
use App\Models\TrdTire2\Transaction\{DelivHdr, DelivPacking, DelivPicking};
use App\Models\SysConfig1\ConfigRight;
use App\Models\TrdTire2\Master\GoldPriceLog;
                ...
                ->format(function ($value, $row, Column $column) {
                    return view('layout.customs.data-table-action', [
                        ...
                        'custom_actions' => [
                            // [
                            //     'label' => 'Print',
                            //     'route' => route('TrdTire2..PurchaseDelivery.PrintPdf', [
                            //         'action' => encryptWithSessionKey('Edit'),
